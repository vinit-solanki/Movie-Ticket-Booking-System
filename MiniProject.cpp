...
public:
    ...
    Book(int row, int col, int NoOfTickets)
    {
        do
        {
            if (row > n || row < 0 || col > m || col < 0)
            {
                cout << "Enter Valid Row Or Column Number...." << endl;
            }
            if (!Box[row][col])
                cout << "This Seat is Reserved!,Please Pick Some Other Seats" << endl;
            else
            {
                Box[row][col] = 0;
                cout << "Your Ticket Is Book!" << endl;
                cout << "Ticket:"
                     << "Row " << row << "Column" << col << endl;
                cout << "Seat Booked:" << row << " " << col << endl;
            }
        } while (NoOfTickets--);
    }
};
    ...
    do
    {
        ...
        case 2:
        {
            ...
            case 3:{
                ...
                int NoOfTickets;
                cout << "Enter No. Tickets:";
                cin >> NoOfTickets;
                Book b(10,10);
                b.ShowAvailableSeats();
                Book(10, 10, NoOfTickets);
                }
                break;
            default:
                cout << "Invalid option. Try again." << endl;
